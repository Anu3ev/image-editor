...
declare module 'fabric' {
  ...
  interface FabricObject {
    ...
    /**
     * Модель хранения внутренних отступов текста внутри фигуры.
     * В актуальной версии в shapePadding* сохраняются только пользовательские px-значения.
     */
    shapePaddingMode?: 'user';

    /**
     * Верхний внутренний отступ текстовой области внутри фигуры в пикселях.
     */
    shapePaddingTop?: number;

    /**
     * Правый внутренний отступ текстовой области внутри фигуры в пикселях.
     */
    shapePaddingRight?: number;

    /**
     * Нижний внутренний отступ текстовой области внутри фигуры в пикселях.
     */
    shapePaddingBottom?: number;

    /**
     * Левый внутренний отступ текстовой области внутри фигуры в пикселях.
     */
