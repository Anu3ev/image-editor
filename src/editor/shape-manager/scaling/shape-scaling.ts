...
export default class ShapeScalingController {
  ...
  public handleObjectScaling = (
    ...
    const padding = ShapeScalingController._resolveEffectivePadding({ group })
  ...
  public handleObjectModified = (event: ShapeModifiedEvent): void => {
    ...
    const textInset = ShapeScalingController._resolveTextInset({
      group,
      width,
      height
    })
   ...
   */
  private static _resolveTextInset({
    group,
    width,
    height
  }: {
