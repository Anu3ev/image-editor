import { createScaleSnapCandidates } from '../../../../src/editor/snapping-manager/scale-snap-candidates'
import { createScaleBounds } from '../../../test-utils/shared/scale-snapping-core'
