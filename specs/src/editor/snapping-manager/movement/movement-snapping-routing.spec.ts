...
const UNIFIED_MOVEMENT_TARGETS = [
  ...
  { kind: 'active-selection-texts', label: 'общего выделения отдельных текстов' }
...
const LEGACY_MOVEMENT_TARGETS = [
  ...
  { kind: 'active-selection-with-nested-image', label: 'общего выделения с вложенным изображением' },
  { kind: 'active-selection-with-scaled-text', label: 'масштабированного общего выделения с текстом' },
  { kind: 'active-selection-with-unknown-object', label: 'общего выделения с неизвестным объектом' },
